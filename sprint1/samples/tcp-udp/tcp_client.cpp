...
int main(int argc, char** argv) {
    ...
    // Создаем сокет, который будет использоваться для общения с сервером. Он привязан к io_context.
    tcp::socket socket{io_context};
    
    // Подключаемся к серверу, используя endpoint. Если возникает ошибка, она будет сохранена в объекте ec.
